...
<h2><u>Transfered Loan report from <?php echo $this->input->post('start_date') ;?> to <?php echo $this->input->post('end_date') ;?></u></h2>
...
<th style="font-size:14;text-align:Right">Description</th>
...
<?php foreach ($loansnotyetpaid as $memberloan) :?>  
   <tr style="border:1px solid #ccc;">
    ...
    <td style="border:1px solid #ccc;font-size:12px; text-align:Right"><?php echo $memberloan->balance;$sum_loanyetpaid+=$memberloan->balance; ?></td>
     <td style="border:1px solid #ccc;font-size:12px; text-align:Right"><?php echo $memberloan->description; ?></td>
...
<br>
<div class="pull-right"><b><?php echo "Total Loan Amount "?><u> <?php echo ":".number_format(intval($sum_loan));  echo "  rwf "?></u> </b></div>
<br>
<div class="pull-right"><b><?php echo "Total Paid "?><u> <?php echo ":".number_format(intval($sum_loanpaid)); echo "  rwf "?></u></b></div>
<br>
<?php else: ?>
	No Loan available.
<?php endif; ?>
