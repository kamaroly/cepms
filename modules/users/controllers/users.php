...
class Users extends MX_Controller {
    ...
    function index()
    {
        ...
        elseif (!$this->ion_auth->is_admin())
        {
            ...
            $this->session->set_flashdata('errors','Only administrator is allowed to do that action');
               
               #if he comeds from another page take him to the previous page 
